...
type streamObservation struct {
	...
	// 変数の今の値ではない。待ちを抜けた後の倍加も、初期値に戻す 4 つの経路も、次に待ちに入るまで
	// 記録に現れない。4 つのうち実際に待ちを打ち切るのは 1 つ(新しいハンドシェイクによる再接続)だけで、
	// 残る 3 つは待ちに入る前に continue する経路であり、待ちを打ち切ってはいない。どちらの場合も
	// つながっている間の Backoff は最後に待った間隔のままである
